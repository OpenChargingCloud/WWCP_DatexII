...
namespace cloud.charging.open.protocols.DatexII.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class DatexII_LoadExamples_Tests
    {

        #region Load_EnergyInfrastructureTablePublication()

        /// <summary>
        /// A test...
        /// </summary>
        [Test]
        public void Load_EnergyInfrastructureTablePublication()
        {
        ...
        #region Load_EnergyInfrastructureStatusPublication()

        /// <summary>
        /// A test...
        /// </summary>
        [Test]
        public void Load_EnergyInfrastructureStatusPublication()
        {
