...
namespace cloud.charging.open.protocols.DatexII
{
    ...
    /// <summary>
    /// A versioned reference to an OrganisationSpecification. The targetClass attribute is fixed to "fac:OrganisationSpecification".
    /// </summary>
                                         ...
                                         OrganisationTableVersionedReference?         OrganisationTableReference   = null) : AOrganisation
    {
        ...
        //public ExtensionType? OrganisationByReferenceExtension { get; set; }
