...
namespace cloud.charging.open.protocols.DatexII
{
    ...
    public class DayWeekMonth(IEnumerable<DayEnum>?          ApplicableDay     = null,
                              IEnumerable<MonthOfYearEnum>?  ApplicableMonth   = null)
    {
        ...
        public IEnumerable<DayEnum>          ApplicableDay      { get; set; } = ApplicableDay?.  Distinct() ?? [];
        ...
        public IEnumerable<MonthOfYearEnum>  ApplicableMonth    { get; set; } = ApplicableMonth?.Distinct() ?? [];
