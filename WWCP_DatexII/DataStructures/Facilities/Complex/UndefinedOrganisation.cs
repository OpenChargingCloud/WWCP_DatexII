...

    {
        ...
        public override XElement ToXML(XName? XMLName = null)
            ...
            => new (XMLName ?? DatexIINS.Facilities + "organisation",
                   ...
                   new XAttribute(DatexIINS.XSI + "type",   "fac:UndefinedOrganisation"),

                   ToXMLElements(),

                   UndefinedOrganisationExtension is not null
                       ? new XElement(DatexIINS.Facilities + "_undefinedOrganisationExtension", UndefinedOrganisationExtension)
                       : null
