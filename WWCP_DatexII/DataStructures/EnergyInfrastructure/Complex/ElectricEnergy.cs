...
namespace cloud.charging.open.protocols.DatexII.v3.EnergyInfrastructure
{
                                ...
                                IEnumerable<EnergyRate>?                 EnergyRates                  = null)
    {
        ...
        public MultilingualString?                     EnergyProductName             { get; set; } = EnergyProductName;
        ...
        public Boolean?                                IsGreenEnergy                 { get; set; } = IsGreenEnergy;
        ...
        public Double?                                 CarbonDioxideImpact           { get; set; } = CarbonDioxideImpact;
        ...
        public Double?                                 NuclearWasteImpact            { get; set; } = NuclearWasteImpact;
        ...
        public IEnumerable<EnergyRateReference>        EnergyRateByReference         { get; set; } = EnergyRateByReference?.     Distinct() ?? [];
        ...
        public IEnumerable<ElectricEnergySourceRatio>  ElectricEnergySourceRatios    { get; set; } = ElectricEnergySourceRatios?.Distinct() ?? [];
        ...
        public IEnumerable<EnergyRate>                 EnergyRates                   { get; set; } = EnergyRates?.               Distinct() ?? [];
        ...
        public XElement?                               ElectricEnergyExtension       { get; set; }
