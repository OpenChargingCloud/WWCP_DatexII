...
namespace cloud.charging.open.protocols.DatexII
{
    ...
    public class EnergyInfrastructureStation(String                                             Id,
                                             ...
                                             IEnumerable<AuthenticationAndIdentificationTypes>  AuthenticationAndIdentificationMethods,
...

    {
        ...
        public String                                             StationIdBNetzA                           { get; set; } = StationIdBNetzA;
        ...
        public Watt                                               TotalMaximumPower                         { get; set; } = TotalMaximumPower;
        ...
        public IEnumerable<AuthenticationAndIdentificationTypes>  AuthenticationAndIdentificationMethods    { get; set; } = AuthenticationAndIdentificationMethods.Distinct();
        ...
        public UInt16                                             NumberOfRefillPoints                      { get; set; } = NumberOfRefillPoints;
        ...
        public IEnumerable<VersionedReference>                    RefillPointByReference                    { get; set; } = RefillPointByReference?.               Distinct() ?? [];
        ...
        public IEnumerable<Languages>                             UserInterfaceLanguages                    { get; set; } = UserInterfaceLanguages?.               Distinct() ?? [];

        /// <summary>
        /// The distributor of the energy.
        /// </summary>
        [XmlElement("energyDistributor", Namespace = "http://datex2.eu/schema/3/facilities")]
        public AOrganisation?                                     EnergyDistributor                         { get; set; } = EnergyDistributor;
        ...
        public IEnumerable<AOrganisation>                         MobilityServiceProviders                  { get; set; } = MobilityServiceProviders?.             Distinct() ?? [];

        /// <summary>
        /// Supported roaming platforms.
        /// </summary>
        [XmlElement("roamingPlatform", Namespace = "http://datex2.eu/schema/3/facilities")]
        public IEnumerable<AOrganisation>                         RoamingPlatforms                          { get; set; } = RoamingPlatforms?.                     Distinct() ?? [];
        ...
        public IEnumerable<RefillPoint>                           RefillPoints                              { get; set; } = RefillPoints?.                         Distinct() ?? [];
        ...
        //public ExtensionType? EnergyInfrastructureStationExtension { get; set; }
