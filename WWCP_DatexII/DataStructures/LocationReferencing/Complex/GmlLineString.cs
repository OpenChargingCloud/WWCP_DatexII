...
namespace cloud.charging.open.protocols.DatexII.v3.LocationReferencing
{
                               ...
                               XElement?   GMLLineStringExtension   = null)
    {
        ...
        public GMLPosList  PosList                   { get; } = PosList;
        ...
        public UInt32?     SrsDimension              { get; } = SrsDimension;
        ...
        public String?     SrsName                   { get; } = SrsName;
        ...
        public XElement?   GMLLineStringExtension    { get; } = GMLLineStringExtension;
